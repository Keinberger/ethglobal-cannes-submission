...
const billionairesOpinions: opinionType[] = [
  {
    ...
    stance: 'no',
    amount: 250,
    text: 'Wealth concentration is fundamentally harmful to society',
    timestamp: '3m ago',
  },
  {
    author: 'EconStudent',
    stance: 'yes',
    amount: 100,
    text: 'They create jobs and drive innovation',
    timestamp: '5m ago',
  },
  {
    author: 'Sarah M.',
    stance: 'no',
    amount: 150,
    text: 'No one needs that much money while others suffer',
    timestamp: '7m ago',
  },
  { author: 'BusinessOwner', stance: 'yes', amount: 300, text: '', timestamp: '10m ago' },
  {
    ...
    stance: 'no',
    amount: 75,
    text: 'Tax them heavily and redistribute',
    timestamp: '12m ago',
  },
  {
    author: 'InvestorMike',
    stance: 'yes',
    amount: 500,
    text: 'Free market capitalism at work',
    timestamp: '15m ago',
  },
];
...
const gazaOpinions: opinionType[] = [
  {
    ...
    stance: 'no',
    amount: 200,
    text: 'Violence never solves underlying issues',
    timestamp: '7m ago',
  },
  {
    ...
    stance: 'no',
    amount: 150,
    text: 'Diplomatic solutions are always better',
    timestamp: '10m ago',
  },
  {
    author: 'HistoryBuff',
    stance: 'yes',
    amount: 100,
    text: 'Sometimes force is the only language understood',
    timestamp: '12m ago',
  },
  {
    author: 'MiddleEastExpert',
    stance: 'no',
    amount: 300,
    text: 'This cycle of violence must end',
    timestamp: '15m ago',
  },
...
const aiOpinions: opinionType[] = [
  {
    ...
    stance: 'yes',
    amount: 400,
    text: 'AI will free us from mundane tasks and allow more creativity',
    timestamp: '2m ago',
  },
  {
    author: 'FutureWorker',
    stance: 'no',
    amount: 200,
    text: 'Job displacement will cause massive suffering',
    timestamp: '4m ago',
  },
  {
    ...
    stance: 'yes',
    amount: 350,
    text: 'AI can solve climate change and disease',
    timestamp: '6m ago',
  },
  {
    ...
    stance: 'no',
    amount: 100,
    text: 'Human connection and meaning will be lost',
    timestamp: '8m ago',
  },
  { author: 'StartupFounder', stance: 'yes', amount: 600, text: '', timestamp: '11m ago' },
  {
    ...
    stance: 'no',
    amount: 250,
    text: "Too many risks we don't understand yet",
    timestamp: '13m ago',
  },
];
...
const climateOpinions: opinionType[] = [
  {
    ...
    stance: 'yes',
    amount: 500,
    text: 'We have less than 10 years to act decisively',
    timestamp: '1m ago',
  },
  {
    author: 'EnergyWorker',
    stance: 'no',
    amount: 180,
    text: 'Green transition will destroy millions of jobs',
    timestamp: '3m ago',
  },
  {
    ...
    stance: 'yes',
    amount: 220,
    text: 'The planet is more important than short-term profits',
    timestamp: '5m ago',
  },
  {
    author: 'EconAnalyst',
    stance: 'no',
    amount: 400,
    text: 'Cost would bankrupt developing nations',
    timestamp: '8m ago',
  },
  {
    author: 'YouthClimate',
    stance: 'yes',
    amount: 150,
    text: 'My generation will inherit this mess',
    timestamp: '12m ago',
  },
];
...
const cryptoOpinions: opinionType[] = [
  {
    ...
    stance: 'yes',
    amount: 800,
    text: 'Decentralized money is the future of freedom',
    timestamp: '4m ago',
  },
  {
    author: 'TradFi_Banker',
    stance: 'no',
    amount: 300,
    text: 'Too volatile and risky for mainstream adoption',
    timestamp: '6m ago',
  },
  {
    author: 'DeFi_Builder',
    stance: 'yes',
    amount: 450,
    text: "Traditional finance is broken, we're fixing it",
    timestamp: '9m ago',
  },
  {
    author: 'RegulatorJoe',
    stance: 'no',
    amount: 200,
    text: 'Needs proper oversight to prevent fraud',
    timestamp: '11m ago',
  },
  {
    author: 'TechInvestor',
    stance: 'yes',
    amount: 600,
    text: 'Blockchain tech will revolutionize everything',
    timestamp: '14m ago',
  },
  {
    author: 'EnergyExpert',
    stance: 'no',
    amount: 250,
    text: 'Environmental impact is catastrophic',
    timestamp: '17m ago',
  },
];
...
const remoteOpinions: opinionType[] = [
  {
    ...
    stance: 'yes',
    amount: 320,
    text: "Best work-life balance I've ever had",
    timestamp: '2m ago',
  },
  {
    ...
    stance: 'no',
    amount: 180,
    text: 'Team collaboration suffers significantly',
    timestamp: '5m ago',
  },
  {
    author: 'WorkingParent',
    stance: 'yes',
    amount: 275,
    text: 'Finally can spend time with my kids',
    timestamp: '7m ago',
  },
  {
    author: 'StartupCEO',
    stance: 'no',
    amount: 400,
    text: 'Company culture dies without in-person interaction',
    timestamp: '10m ago',
  },
  {
    author: 'DevOps_Pro',
    stance: 'yes',
    amount: 350,
    text: 'More productive without office distractions',
    timestamp: '13m ago',
  },
];
