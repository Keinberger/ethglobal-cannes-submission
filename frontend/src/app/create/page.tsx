    ...
    <div className="min-h-screen pb-24">
        <main className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">Share your perspective and spark meaningful discussions</p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <span className={`text-sm ${questionLength > 100 ? 'text-red-500' : 'text-gray-400'}`}>
                      {questionLength}/120
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <span className={`text-sm ${descriptionLength > 250 ? 'text-red-500' : 'text-gray-400'}`}>
                ...
                >
                  {!ready ? 'Loading...' : isSubmitting ? 'Creating Debate...' : !authenticated ? 'Login to Create Debate' : 'Create Debate'}
                </button>
              </form>
            </div>
